...
export default function TermsAndConditionsScreen() {
    ...
    return (
        <ScrollView className="p-4 bg-white">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">1. Welcome</Text>
            <Text className="mb-4">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">2. Description of Service</Text>
            <Text className="mb-4">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">3. Affiliate Role Disclosure</Text>
            <Text className="mb-4">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">4. Information You Provide</Text>
            <Text className="mb-4">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">5. Use of Your Information</Text>
            <Text className="mb-4">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">6. No Guarantee of Results</Text>
            <Text className="mb-4">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">7. Opt-Out Responsibility</Text>
            <Text className="mb-4">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">8. Dispute Resolution and Arbitration</Text>
            <Text className="mb-4">
                You agree that any dispute related to your use of the platform shall be resolved through binding individual arbitration under the rules of the American Arbitration Association. You waive the right to participate in any class or representative action. You may opt out of arbitration within 30 days of first submitting your information by sending written notice to Info@myleadwell.com.
            </Text>

            <Text className="text-lg font-semibold mt-4 mb-2">9. Prohibited Conduct</Text>
            <Text className="mb-4">
                You agree not to:
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">10. Intellectual Property</Text>
            <Text className="mb-4">
            ...
            <Text className="text-lg font-semibold mt-4 mb-2">11. Updates to These Terms</Text>
            <Text className="mb-4">
                We may modify these Terms at any time. Continued use of our services constitutes your acceptance of any updates. Material changes will be announced via our platform.
            </Text>

            <Text className="text-lg font-semibold mt-4 mb-2">12. Contact Information</Text>
